...
//			double sgn = Util.sign(x2 - draw_ox);
//			int x, y;
...
//			gridStep *= 10;
//		}
//		double tstart = sim.getT() - sim.timeStep * speed * rect.width;
